...
public class GeyserPlumeParticleMixin implements ParticleScaleInterface {
	...
	public ParticleScaleHandler particleTweaks$createScaleHandler() {
		...
		entrance.setToZero();
		final ParticleScaler exit = new ParticleScaler(ParticleScaler.ScaleMethod.SIZE, 0.375F);
