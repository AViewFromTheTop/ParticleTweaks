...
public final class ParticleTweaksPreLoadConstants {
	...
	public static final boolean HAS_WILDERWILD = ModLoader.isModLoaded("wilderwild");
	public static final boolean HAS_THECOPPERIERAGE = ModLoader.isModLoaded("thecopperierage");

	public static Path configPath(String name, boolean json5) {
		return Path.of("./config/" + MOD_ID + "/" + name + "." + (json5 ? "json5" : "json"));
	}

	private ParticleTweaksPreLoadConstants() {}
}
